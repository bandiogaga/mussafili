...
?>
		...
		<option value="F">Female</option>
                ...
                <input type="Submit" name="submit_parent" value="Register Parent">
            </form>
            <?php
	if(isset($_POST["submit_parent"])){
		...
		if($_POST["password"] === $_POST["password2"]){
			...
			$stmt->execute(['P',$_POST["email"],$hash,$_POST["fname"], $_POST["lname"], $_POST["dob"], $_POST["sex"], $_POST["phone"], $_POST["photo"], $ip]);
			echo "<br>";
			echo "added parent!";
			echo "redirect to...?";
		} else{
